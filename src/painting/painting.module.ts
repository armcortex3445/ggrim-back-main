...
@Module({
  imports: [TypeOrmModule.forFeature([Painting, WikiArtPainting, Tag, Style]), ArtistModule],
  controllers: [PaintingController],
  providers: [PaintingService, WikiArtPaintingService, StyleService, TagService],
